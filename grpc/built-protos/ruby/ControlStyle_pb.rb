...
module CLIPPY
  module Control
    ControlStyle = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("CLIPPY.control.ControlStyle").msgclass
    ControlStyleEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("CLIPPY.control.ControlStyleEnum").enummodule
  end
end
