...
static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, 18, -1, sizeof(::CLIPPY::control::Waypoint)},
};
...
static const ::_pbi::DescriptorTable* const descriptor_table_Waypoint_2eproto_deps[1] =
    {
...
Waypoint::Waypoint(const Waypoint& from) : ::google::protobuf::Message() {
  ...
  ::memcpy(&_impl_.x_, &from._impl_.x_,
    static_cast<::size_t>(reinterpret_cast<char*>(&_impl_.waypoint_type_) -
    reinterpret_cast<char*>(&_impl_.x_)) + sizeof(_impl_.waypoint_type_));
...
// @@protoc_insertion_point(message_clear_start:CLIPPY.control.Waypoint)
  ...
  ::memset(&_impl_.x_, 0, static_cast<::size_t>(
      reinterpret_cast<char*>(&_impl_.waypoint_type_) -
      reinterpret_cast<char*>(&_impl_.x_)) + sizeof(_impl_.waypoint_type_));
...
const ::_pbi::TcParseTable<4, 10, 1, 0, 2> Waypoint::_table_ = {
  {
...
void Waypoint::InternalSwap(Waypoint* other) {
  ...
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Waypoint, _impl_.waypoint_type_)
      + sizeof(Waypoint::_impl_.waypoint_type_)
