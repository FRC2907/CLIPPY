...
const ::uint32_t TableStruct_ControlTarget_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    PROTOBUF_FIELD_OFFSET(::CLIPPY::control::ControlTarget, _impl_.urgency_),
    ...
    PROTOBUF_FIELD_OFFSET(::CLIPPY::control::MultiSystemControlTarget, _impl_.urgency_),
...
static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, 18, -1, sizeof(::CLIPPY::control::ControlTarget)},
        {27, 38, -1, sizeof(::CLIPPY::control::MultiSystemControlTarget)},
};
...
const char descriptor_table_protodef_ControlTarget_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\023ControlTarget.proto\022\016CLIPPY.control\032\rU"
    "rgency.proto\032\037google/protobuf/timestamp."
    "proto\"\375\001\n\rControlTarget\022-\n\ttimestamp\030\001 \001"
    "(\0132\032.google.protobuf.Timestamp\022\021\n\tsystem"
    "_id\030\002 \001(\t\022(\n\007urgency\030\003 \001(\0162\027.CLIPPY.cont"
    ...
    "LIPPY.control.ControlTargetb\006proto3"
};
static const ::_pbi::DescriptorTable* const descriptor_table_ControlTarget_2eproto_deps[2] =
    {
...
const ::_pbi::TcParseTable<2, 9, 1, 54, 2> ControlTarget::_table_ = {
  {
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(ControlTarget, _impl_.urgency_), 63>(),
     {24, 63, 0, PROTOBUF_FIELD_OFFSET(ControlTarget, _impl_.urgency_)}},
  }}, {{
    65535, 65535
  }}, {{
    // .google.protobuf.Timestamp timestamp = 1;
...
void ControlTarget::InternalSwap(ControlTarget* other) {
  ...
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ControlTarget, _impl_.urgency_)
      + sizeof(ControlTarget::_impl_.urgency_)
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<2, 3, 2, 0, 2> MultiSystemControlTarget::_table_ = {
  {
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(MultiSystemControlTarget, _impl_.urgency_), 63>(),
     {16, 63, 0, PROTOBUF_FIELD_OFFSET(MultiSystemControlTarget, _impl_.urgency_)}},
    ...
    (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
    // .CLIPPY.control.Urgency urgency = 2;
    {PROTOBUF_FIELD_OFFSET(MultiSystemControlTarget, _impl_.urgency_), -1, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kOpenEnum)},
    // repeated .CLIPPY.control.ControlTarget targets = 3;
...
void MultiSystemControlTarget::InternalSwap(MultiSystemControlTarget* other) {
  ...
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MultiSystemControlTarget, _impl_.urgency_)
      + sizeof(MultiSystemControlTarget::_impl_.urgency_)
      - PROTOBUF_FIELD_OFFSET(MultiSystemControlTarget, _impl_.timestamp_)>(
          reinterpret_cast<char*>(&_impl_.timestamp_),
          reinterpret_cast<char*>(&other->_impl_.timestamp_));
}
