...
class ControlGains(_message.Message):
    __slots__ = ("system_id", "kP", "kI", "kD", "kF_static", "kF_linear", "kF_square", "kF_cosine")
    ...
    kF_square: float
    kF_cosine: float
    def __init__(self, system_id: _Optional[str] = ..., kP: _Optional[float] = ..., kI: _Optional[float] = ..., kD: _Optional[float] = ..., kF_static: _Optional[float] = ..., kF_linear: _Optional[float] = ..., kF_square: _Optional[float] = ..., kF_cosine: _Optional[float] = ...) -> None: ...
