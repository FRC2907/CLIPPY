...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in DoNothing_pb2_grpc.py depends on'
...
class DoNothingServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_DoNothingServicer_to_server(servicer, server):
    rpc_method_handlers = {
