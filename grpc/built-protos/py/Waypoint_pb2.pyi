...
class Waypoint(_message.Message):
    __slots__ = ("timestamp", "waypoint_type", "x", "y", "z", "t_xy", "dx", "dy", "dz", "dt_xy")
    ...
    dz: float
    dt_xy: float
    def __init__(self, timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., waypoint_type: _Optional[_Union[WaypointType, str]] = ..., x: _Optional[float] = ..., y: _Optional[float] = ..., z: _Optional[float] = ..., t_xy: _Optional[float] = ..., dx: _Optional[float] = ..., dy: _Optional[float] = ..., dz: _Optional[float] = ..., dt_xy: _Optional[float] = ...) -> None: ...
